...
oRecord = CustomFeatureExtractionRecord("FV-004-102-007A", "Applying non-parametric per centre COMBAT harmonization", m2dHarmonizedFeatures_LRCP);
...
oFV = ExperimentFeatureValues("FV-004-102-007A");
