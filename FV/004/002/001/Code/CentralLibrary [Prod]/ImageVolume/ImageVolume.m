...
% %                 vdTranslations_mm (1,3) double {mustBeFinite} = [0 0 0]
        ...
        function NormalizeIntensityLinearly(obj, dCurrentMinIntensityValue, dNewMinIntensityValue, dCurrentMaxIntensityValue, dNewMaxIntensityValue, chNewImageDataClass)
            arguments
                obj
            ...
            oTransform = LinearIntensityNormalizationTransform(obj, dCurrentMaxIntensityValue, dNewMaxIntensityValue, dCurrentMinIntensityValue, dNewMinIntensityValue, chNewImageDataClass);
