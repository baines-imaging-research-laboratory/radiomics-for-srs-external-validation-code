...
oFV = ExperimentManager.Load('FV-004-002-002');
...
oRecord = CustomFeatureExtractionRecord("FV-004-002-002A", oFeatureValues.GetFeatureExtractionRecord(1).GetFeatureExtractionRecordPortions.GetDescription(), oFeatureValues.GetFeatures());
...
oFV = ExperimentFeatureValues("FV-004-002-002A");
