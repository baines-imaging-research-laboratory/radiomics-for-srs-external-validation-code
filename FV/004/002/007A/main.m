...
oFV = ExperimentManager.Load('FV-004-002-007');
...
oRecord = CustomFeatureExtractionRecord("FV-004-002-007A", oFeatureValues.GetFeatureExtractionRecord(1).GetFeatureExtractionRecordPortions.GetDescription(), oFeatureValues.GetFeatures());
...
oFV = ExperimentFeatureValues("FV-004-002-007A");
