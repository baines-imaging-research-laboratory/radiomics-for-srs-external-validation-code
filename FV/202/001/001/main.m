...
oFV_LRCP = ExperimentManager.Load('FV-003-002-001A');
oFeatureValues_LRCP = oFV_LRCP.GetFeatureValues();

oFV_VUMC = ExperimentManager.Load('FV-101-004-001');
oFeatureValues_VUMC = oFV_VUMC.GetFeatureValues();

% Create new feature values object
oRecord = CustomFeatureExtractionRecord("FV-202-001-001", oFeatureValues_VUMC.GetFeatureExtractionRecord(1).GetFeatureExtractionRecordPortions.GetDescription(), [oFeatureValues_VUMC.GetFeatures(); oFeatureValues_LRCP.GetFeatures()]);
...
oFV = ExperimentFeatureValues("FV-202-001-001");
