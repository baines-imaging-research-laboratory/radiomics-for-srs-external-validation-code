...
oFV_LRCP = ExperimentManager.Load('FV-004-002-005A');
oFeatureValues_LRCP = oFV_LRCP.GetFeatureValues();

oFV_VUMC = ExperimentManager.Load('FV-102-001-005');
oFeatureValues_VUMC = oFV_VUMC.GetFeatureValues();

% Create new feature values object
oRecord = CustomFeatureExtractionRecord("FV-201-001-005", oFeatureValues_VUMC.GetFeatureExtractionRecord(1).GetFeatureExtractionRecordPortions.GetDescription(), [oFeatureValues_VUMC.GetFeatures(); oFeatureValues_LRCP.GetFeatures()]);
...
oFV = ExperimentFeatureValues("FV-201-001-005");
