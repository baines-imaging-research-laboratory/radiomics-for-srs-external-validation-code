...
oRecord = CustomFeatureExtractionRecord("FV-102-101-008", "Applying non-parametric per centre COMBAT harmonization", m2dHarmonizedFeatures_VUMC);
...
oFV = ExperimentFeatureValues("FV-102-101-008");
