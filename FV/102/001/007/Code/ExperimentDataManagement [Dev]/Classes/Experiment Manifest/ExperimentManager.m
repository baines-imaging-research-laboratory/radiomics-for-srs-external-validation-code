classdef ExperimentManager
    ...
    methods (Access = public, Static = true)
        ...
        function [vsClinicalFeatureValueCodes_Training, vsRadiomicFeatureValueCodes_Training, sLabelsCode_Training, vsClinicalFeatureValueCodes_Testing, vsRadiomicFeatureValueCodes_Testing, sLabelsCode_Testing, sModelCode, sHPOCode, sObjFcnCodeForHPO, vsFSCodes] = LoadExperimentManifestCodesMatFile(sManifestCodesFilePath)
            arguments
