...
oTrainingOOBSamplesGuessResult = FileIOUtils.LoadMatFile(fullfile(sExpResultsPath, "02 Cutoff Evaluation", "Training Artifacts (5).mat"), "oOOBSamplesGuessResult");
oTestingSamplesGuessResult = FileIOUtils.LoadMatFile(fullfile(sExpResultsPath, "02 Cutoff Evaluation", "Testing Artifacts (5).mat"), "oTestingGuessResult");
