% Univariate analysis of LRCP clinical features to separate + vs -
Experiment.StartNewSection('Analysis');

% load features
vsFeatureValueCodes = "FV-003-002-001A";
...
% Save p-values
FileIOUtils.SaveMatFile(fullfile(Experiment.GetResultsDirectory(), 'P-Values for LRCP- vs LRCP+ Per Clinical Feature.mat'), ...
