...
vdNumberOfFeaturesCutoffsToRun = 2:1:10;
...
oManager = Experiment.GetLoopIterationManager(dNumCutoffsToRun);

parfor dCutoffIndex=1:dNumCutoffsToRun
    oManager.PerLoopIndexSetup(dCutoffIndex);
    ...
    vdAUCPerCutoff(dCutoffIndex) = ErrorMetricsCalculator.CalculateAUC(oTestingGuessResult, 'JournalingOn', false);
